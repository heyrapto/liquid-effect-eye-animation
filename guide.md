we need a 3d privacy/security related bear right in the middle of the webpage replacing any king of text in 

liquid-effect-animation.tsx
. we dont need any text only the bear right in the middle and it's eye should follow the cursor at all time like this:
import './style.css'
